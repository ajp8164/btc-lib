...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'https://btccore.io/api/lib/transaction#serialization-checks';
 ...
 * and a slightly fancier format recognized by btccore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a btccore Address object. The
 * same is true for `script`, which can be a string or a btccore Script.
 *
