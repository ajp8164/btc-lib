...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'https://btc.io/api/lib/transaction#serialization-checks';
 ...
 * and a slightly fancier format recognized by btc:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a btc Address object. The
 * same is true for `script`, which can be a string or a btc Script.
 *
