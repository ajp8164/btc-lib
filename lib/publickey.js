 ...
 * @param {Networks=} extra.network - Which network should the address for this public key be for
 ...
 *
 * @param {String|Networks=} network - Which network should the address be for
